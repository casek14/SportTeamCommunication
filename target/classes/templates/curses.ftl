 ...
 <div class="container">
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/fotbal.jpg" alt="Fotbal">
                </figure>
            </div>
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/hockey.jpg" alt="Hockey">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/box.jpg" alt="Box">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/jog.jpg" alt="Jogging">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/tennis.jpg" alt="Tennis">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="img/curses/gym.jpg" alt="Gym">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
