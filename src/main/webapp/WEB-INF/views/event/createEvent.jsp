            ...
            <div class="container has-text-centered">
               <div class="column is-4 is-offset-4">
                  ...
                  <s:form  commandName="eventData" action="${pageContext.request.contextPath }/event/create" method="post">
                     ...
                     <div class="field">
                        <div class="control">
                           <s:input path="description" class="input is-large" type="text" placeholder="Description" autofocus="" />
                     ...
                     <div class="field">
                      ...
                      <input class="button is-block is-info is-large" type="submit" value="Create"/>
                  </s:form>
               </div>
            </div>
         </div>
