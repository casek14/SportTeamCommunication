   ...
   <div class="container">
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/fotbal.jpg" alt="Fotbal">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
                    <div class="media-content">
                        <p class="title is-4">Fotbal</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/hockey.jpg" alt="Hockey">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
                    <div class="media-content">
                        <p class="title is-4">Hockey</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/box.jpg" alt="Box">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/jog.jpg" alt="Jogging">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
                    <div class="media-content">
                        <p class="title is-4">Jogging</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/tennis.jpg" alt="Tennis">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
                    <div class="media-content">
                        <p class="title is-4">Tennis</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image">
                    <img src="${pageContext.request.contextPath}/resources/img/curses/gym.jpg" alt="Gym">
                </figure>
            </div>
            <div class="card-content">
                <div class="media">
                    <div class="media-content">
                        <p class="title is-4">Gym</p>
                    </div>
                </div>
