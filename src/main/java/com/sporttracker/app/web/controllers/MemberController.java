...
import com.sporttracker.app.web.validation.MemberValidation;
...
public class MemberController {
	...
	public String saveMember(ModelMap model, @ModelAttribute("memberData") @Valid Member member, BindingResult br,
			HttpSession session) {
